...
start_marker = "    # ---------------- command execution ----------------"
end_marker = "    # ---------------- viewer ----------------"
...
if start == -1:
    raise RuntimeError("Could not find command execution section.")

if end == -1:
    raise RuntimeError("Could not find viewer section.")
...
print("✅ Fixed command execution, vision check, and action encoder methods.")
